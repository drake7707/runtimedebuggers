...
namespace RunTimeDebuggers.Controls.TreeList
{
    internal class ConditionalFormatting
    {
        private Func<TLNode, bool> condition;
    ...
    internal class ColumnSetting
    {
        ...
        public ColumnSetting(TreeListView owner)
        {
            m_owner = owner;
        }
    }
    ...
    internal class OptionsSettingTypeConverter : ExpandableObjectConverter
    {
        public override bool CanConvertTo(ITypeDescriptorContext context, Type destinationType)
        {
            ...
            if (destinationType == typeof(RowSetting))
                return true;
            if (destinationType == typeof(ColumnSetting))
                return true;
        ...
        public override object ConvertTo(ITypeDescriptorContext context, System.Globalization.CultureInfo culture, object value, Type destinationType)
        {
            ...
            if (destinationType == typeof(string) && value.GetType() == typeof(ColumnSetting))
