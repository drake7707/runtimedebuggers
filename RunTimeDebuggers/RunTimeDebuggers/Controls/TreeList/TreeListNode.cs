...
{
    internal class TLNode
    {
        NodeCollection m_owner = null;
        TLNode m_prevSibling = null;
        TLNode m_nextSibling = null;
        ...
        public TLNode PrevSibling
        {
            get { return m_prevSibling; }
        }
        public TLNode NextSibling
        {
        ...
        public TLNode(string text)
        {
            m_data = new object[1] { text };
        }
        public TLNode(params object[] fields)
        {
            SetData(fields);
        }
        object[] m_data = null;
        ...
        internal void InsertBefore(TLNode insertBefore, NodeCollection owner)
        {
            this.m_owner = owner;
            OnParentChanged(EventArgs.Empty);
            TLNode next = insertBefore;
            TLNode prev = null;
            if (next != null)
            {
        ...
        internal void InsertAfter(TLNode insertAfter, NodeCollection owner)
        {
            this.m_owner = owner;
            OnParentChanged(EventArgs.Empty);
            TLNode prev = insertAfter;
            TLNode next = null;
            if (prev != null)
            {
        ...
        {
            TLNode prev = this.PrevSibling;
            TLNode next = this.NextSibling;
            if (prev != null)
        ...
        public IEnumerable<TLNode> GetAllNodes()
        {
            List<TLNode> nodes = new List<TLNode>();
            foreach (TLNode n in Nodes)
            {
                nodes.Add(n);
    ...
    internal class NodeCollection : IEnumerable
    {
        internal int m_version = 0;
        int m_nextId = 0;
        int m_IdDirty = 0;

        TLNode[] m_nodesInternal = null;
        TLNode m_owner = null;
        TLNode m_firstNode = null;
        TLNode m_lastNode = null;
        int m_count = 0;
        public TLNode Owner
        {
            get { return m_owner; }
        }
        public TLNode FirstNode
        {
            get { return m_firstNode; }
        }
        public TLNode LastNode
        {
        ...
        public NodeCollection(TLNode owner)
        {
            m_owner = owner;
        }
        ...
        public TLNode Add(string text)
        {
            return Add(new TLNode(text));
        }
        ...
        public int GetNodeIndex(TLNode node)
        {
            int index = 0;
            TLNode tmp = FirstNode;
        ...
        public TLNode FirstVisibleNode()
        {
            return FirstNode;
        }
        public TLNode LastVisibleNode(bool recursive)
        {
            if (recursive)
                return FindNodesBottomLeaf(LastNode, true);
            return LastNode;
        }
        public virtual void NotifyBeforeExpand(TLNode nodeToExpand, bool expanding)
        {
        }
        public virtual void NotifyAfterExpand(TLNode nodeToExpand, bool expanding)
        {
        }
        ...
        {
            int cnt = 0;
            using (RecursiveNodesEnumerator iterator = new RecursiveNodesEnumerator(this, mustBeVisible))
            {
                while (iterator.MoveNext())
                    cnt++;
            }
        ...
        void EnsureInternalArray()
        {
            ...
            m_nodesInternal = new TLNode[Count];
            int index = 0;
            foreach (TLNode xnode in this)
        ...
        {
            TLNode m_firstNode;
            TLNode m_current = null;
            public NodesEnumerator(TLNode firstNode)
            {
        ...
        internal class RecursiveNodesEnumerator : IEnumerator<TLNode>
        {
            class NodeCollIterator : IEnumerator<TLNode>
            {
                TLNode m_firstNode;
                TLNode m_current;
                bool m_visible;
            ...
            IEnumerator<TLNode> m_enumerator = null;
            public RecursiveNodesEnumerator(TLNode firstNode, bool mustBeVisible)
            {
        ...
        internal class ForwardNodeEnumerator : IEnumerator<TLNode>
        {
            TLNode m_firstNode;
            TLNode m_current;
            bool m_visible;
            public ForwardNodeEnumerator(TLNode firstNode, bool mustBeVisible)
            {
                m_firstNode = firstNode;
                m_visible = mustBeVisible;
            }
        ...
        internal class ReverseNodeEnumerator : IEnumerator<TLNode>
        {
            TLNode m_firstNode;
            TLNode m_current;
            bool m_visible;
            public ReverseNodeEnumerator(TLNode firstNode, bool mustBeVisible)
            {
                m_firstNode = firstNode;
                m_visible = mustBeVisible;
            }
        ...
        public static IEnumerable ReverseNodeIterator(TLNode firstNode, TLNode lastNode, bool mustBeVisible)
        {
            bool m_done = false;
        ...
        public static IEnumerable ForwardNodeIterator(TLNode firstNode, TLNode lastNode, bool mustBeVisible)
        {
            bool m_done = false;
    ...
    internal class NodesSelection : IEnumerable
    {
        List<TLNode> m_nodes = new List<TLNode>();
        Dictionary<TLNode, int> m_nodesMap = new Dictionary<TLNode, int>();
        public void Clear()
        {
            m_nodes.Clear();
            m_nodesMap.Clear();
        ...
        public void Add(TLNode node)
        {
            m_nodes.Add(node);
            m_nodesMap.Add(node, 0);
        }
        public void Remove(TLNode node)
        {
            m_nodes.Remove(node);
            m_nodesMap.Remove(node);
        }
        public bool Contains(TLNode node)
        {
            return m_nodesMap.ContainsKey(node);
        }

        public IList<TLNode> GetSortedNodes()
        {
            SortedList<string, TLNode> list = new SortedList<string, TLNode>();
            foreach (TLNode node in m_nodes)
