...
{
    /// <summary>
    /// Source: http://www.codeproject.com/KB/tree/TreeWithColumns.aspx
    /// </summary>
    //[Designer(typeof(TreeListViewDesigner))]
    internal class TreeListView : Control, ISupportInitialize
    {
        public event TreeViewEventHandler AfterSelect;
        protected virtual void OnAfterSelect(TLNode node)
        {
        ...
        public delegate void NotifyBeforeExpandHandler(TLNode node, bool isExpanding);
        public event NotifyBeforeExpandHandler NotifyBeforeExpand;
        public virtual void OnNotifyBeforeExpand(TLNode node, bool isExpanding)
        {
        ...
        public delegate void NotifyAfterHandler(TLNode node, bool isExpanding);
        public event NotifyAfterHandler NotifyAfterExpand;
        public virtual void OnNotifyAfterExpand(TLNode node, bool isExpanded)
        {
        ...
        [Browsable(true)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Content)]
        public TreeList.ColumnSetting ColumnsOptions
        {
        ...
        TLNode m_firstVisibleNode = null;
        ...
        public TLNode FocusedNode
        {
            get { return m_focusedNode; }
            set
            {
                TLNode curNode = FocusedNode;
        ...
        public TLNode CalcHitNode(Point mousepoint)
        {
        ...
        protected virtual TreeList.TextFormatting GetFormatting(TLNode node, TreeListColumn column)
        {
            if (column.CellFormatConditions != null)
            {
                foreach (var c in column.CellFormatConditions)
                {
                    if (c.IsTrue(node))
                        return c.Formatting;
                }
        ...
        protected virtual void PaintNode(Graphics dc, Rectangle rowRect, TLNode node, TreeListColumn[] visibleColumns, int visibleRowIndex)
        {
        ...
        protected virtual void PaintLines(Graphics dc, Rectangle cellRect, TLNode node)
        {
    ...
    internal class TreeListViewNodes : NodeCollection
    {
        TreeListView m_tree;
        ...
        public override void Remove(TLNode node)
        {
            base.Remove(node);
            m_tree.RecalcLayout();
        }
        ...
        public override void NotifyAfterExpand(TLNode nodeToExpand, bool expanded)
        {
