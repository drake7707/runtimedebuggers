...
namespace RunTimeDebuggers.Controls
{
    ...
    internal class TreeListColumn
    {
        ...
        public TreeList.ConditionalFormatting[] CellFormatConditions { get; set; }
        public TreeList.ConditionalFormatting[] HeaderFormatConditions { get; set; }
    ...
    internal class TreeListColumnCollection : IList<TreeListColumn>, IList
    {
        ColumnHeaderPainter m_painter = new ColumnHeaderPainter();
        TreeList.ColumnSetting m_options;
        ...
        [Browsable(false)]
        public TreeList.ColumnSetting Options
        {
        ...
        {
            m_owner = owner;
            m_options = new TreeList.ColumnSetting(owner);
        }
